...
public class GameController {
    ...
    public void verificarFimDeJogo() {
        if (model.isCheckMate()) {
            ...
            consoleView.atualizarTurno(); // Atualiza a barra de menu com a cor do próximo turno
        }
    }
    ...
    /**
     * Reinicia o jogo com uma nova instância do modelo e atualiza as visualizações.
     */
    private void reiniciar() {
        ...
        if (consoleView != null) {
            consoleView.atualizarTurno();     // Atualiza o turno inicial no menu
        }
    }
}
